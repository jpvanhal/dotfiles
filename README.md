...
- **Brewfile**: This is a list of applications for [Homebrew Cask](https://caskroom.github.io) to install: things like Chrome and 1Password and Adium and stuff.
...
```sh
git clone https://github.com/jpvanhal/dotfiles.git ~/.dotfiles
cd ~/.dotfiles
script/bootstrap
```
...
The main file you'll want to change right off the bat is `fish/fishrc.symlink`,
